...
## Basic example
Basic example with a single testimonial per slide
...
#### Much more examples and a detailed description can be found at [📄 Testimonial Slider documentation page](https://mdbootstrap.com/docs/standard/extended/testimonial-slider/)
